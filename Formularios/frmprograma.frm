...
Begin VB.Form frmprograma 
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdmasmenos 
      Height          =   375
      Index           =   1
      Left            =   11970
      TabIndex        =   55
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdmasmenos 
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn ChameleonBtn1 
      Height          =   255
      Left            =   240
      TabIndex        =   48
      Top             =   0
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn cmdMostrarMeses 
      Height          =   255
      Left            =   10200
      TabIndex        =   47
      Top             =   2400
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn cmdSoloDias 
      Height          =   255
      Left            =   10200
      TabIndex        =   46
      Top             =   2400
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn cmdcod 
      Height          =   255
      Left            =   9960
      TabIndex        =   45
      Top             =   2400
      ...
      Begin VB.PictureBox panel1 
         ...
         Begin MSComCtl2.MonthView meses 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MonthBackColor  =   16711680
            ShowToday       =   0   'False
            StartOfWeek     =   107413506
   ...
   Begin VB.ListBox listado 
      ...
      Width           =   2175
   End
   Begin Virtual_Martin_temporize.ChameleonBtn ChameleonBtn2 
      Height          =   255
      Left            =   2400
      TabIndex        =   49
      Top             =   0
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn ChameleonBtn3 
      Height          =   255
      Left            =   4560
      TabIndex        =   50
      Top             =   0
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn ChameleonBtn4 
      Height          =   255
      Left            =   5880
      TabIndex        =   51
      Top             =   0
      ...
      VALUE           =   0   'False
   End
   Begin Virtual_Martin_temporize.ChameleonBtn ChameleonBtn5 
      Height          =   255
      Left            =   9840
      TabIndex        =   53
      Top             =   0
...
Private Sub abrirArchivo()
 ...
 .Filter = lenguaje_Menu(368) & lenguaje_Menu(376) & "(*.ring)|*.ring|" & lenguaje_Menu(369) & "(*.*)|*.*|"
 .FilterIndex = 1
 .ShowOpen
...
' puertof.apagar_puertos
 ...
 "ring", lenguaje_Menu(368) & lenguaje_Menu(376), App.Path & "\" & "rinter.exe,0"
 abrirExterno
 crear_meses
